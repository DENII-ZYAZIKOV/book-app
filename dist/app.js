(function () {
    ...
    */
    ...
    class Card extends DivComponent {
        ...
        addToFavorites() {
            this.appState.faf.push(this.cardState);
        }

        deleteFromFavorites() {
            this.appState.faf = this.appState.faf.filter(
        ...
        render() {
            ...
            const existInFavorites = this.appState.faf.find(
                b => b.key == this.cardState.key
            );
            this.el.innerHTML = `
    ...
    class FavoritesView extends AbstractView {
        ...
        render() {
            ...
            <h1>Избранное</h1>
        `;
            main.append(new CardList(this.appState,{list: this.appState.faf}).render());
            this.app.innerHTML ='';
    ...
    class Search extends DivComponent {
        ...
        render() {
            ...
            <button class = "search-button" aria-label="Искать"><img src="static/search2.svg" alt ="Иконка поиска"/></button>
        `;
